...
class Course():
	...
	def __init__(self, course_id, is_core =True, class_size=float('inf'), students=None, waitlist = None, difficulty=0, term=3, requirements = None):
		self.course_id = course_id
		self.class_size = class_size
		self.students = [] if students == None else students
		self.waitlist = [] if students == None else students
